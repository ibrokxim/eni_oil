        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    <a type="button" class="btn btn-primary" href="{{ route('products.create') }}">Товары по ценам</a>
                    <br>
                    <br>
                    <div class="card">
                        <h5 class="card-header">Все товары </h5>
                            ...
                            <table class="table">
                                ...
                                @foreach($prs as $product)
                                    <tr>
                                        <td>{{ $product->code }}</td>
                                        <td>{{ $product->name }}</td>
                                        <td>{{ $product->kg_per_unit }}</td>
                                        <td>{{ $product->liters_per_unit }}</td>
                                        <td>3233</td>
                                        <td>455</td>
                                    </tr>
                                @endforeach
