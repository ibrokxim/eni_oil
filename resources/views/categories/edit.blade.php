        ...
        <div class="layout-page">
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4">Категория </h4>
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <h5 class="card-header">Изменить категорию {{ $category->name }}</h5>
                                    ...
                                    >
                                        ...
                                        @foreach($categories as $category)
                                            <option value="{{ $category->id }}"
                                                    @if(isset($currentCategory) && $currentCategory->parent_id === $category->id) selected @endif>
                                                {{ $category->name }}
                                            </option>
                                        @endforeach
