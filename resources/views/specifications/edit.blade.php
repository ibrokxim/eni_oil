            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <h5 class="card-header">Изменить спецификацию {{$specification->name}}</h5>
                                <form action="{{ route('specifications.update', $specification->id) }}" method="post">
                                    ...
                                    <div class="card-body demo-vertical-spacing demo-only-element">
                                        ...
                                        <input type="text" class="form-control" name="name" id="defaultFormControlInput" placeholder="Введите название" aria-describedby="defaultFormControlHelp" value="{{ $specification->name }}"/>

                                        <label for="defaultFormControlInput" class="form-label">Код</label>
                                        <input type="text" class="form-control" name="code" id="defaultFormControlInput" placeholder="Введите код спецификации" aria-describedby="defaultFormControlHelp" value="{{ $specification->code }}"/>

                                        <label for="defaultFormControlInput" class="form-label">Значение</label>
                                        <input type="text" class="form-control" name="value" id="defaultFormControlInput" placeholder="Введите значение" aria-describedby="defaultFormControlHelp" value="{{ $specification->value }}"/>
