        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    <a type="button" class="btn btn-primary" href="{{ route('specifications.create') }}">Добавить Спецификацию</a>
                    <br>
                    <br>
                    <div class="card">
                        <h5 class="card-header">Спецификации  товаров</h5>
                            ...
                            <table class="table">
                                ...
                                @foreach($specifications as $spec)
                                    <tr>
                                        ...
                                        <td>{{ $spec->code }}</td>
                                        <td>{{ $spec->value }}</td>
                                        <td><a href="{{route('specifications.edit', $spec->id)}}" type="button" class="btn btn-primary">Изменить</a></td>
                                        <td><a href="{{route('specifications.delete', $spec->id)}}" type="button" class="btn btn-danger">Удалить</a></td>
                                    </tr>
                                @endforeach
