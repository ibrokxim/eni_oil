        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    <a type="button" class="btn btn-primary" href="{{ route('seo.create') }}">Добавить SEO</a>
                    <br>
                    <br>
                    <div class="card">
                            ...
                            <table class="table">
                                ...
                                @foreach($seos as $product)
                                    <tr>
                                        ...
                                        <td>{{ $product->slug }}</td>
                                        <td><a type="button" href="{{ route('seo.edit', $product->id) }}" class="btn btn-primary">Изменить</a></td>
                                        <td>
                                            <form action="{{ route('seo.delete', $product->id) }}" method="post" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
