...
<head>
    ...
    <title>Create SEO Setting</title>
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4">Создать SEO настройку</h4>
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <h5 class="card-header">Создать SEO настройку</h5>
                                <form action="{{ route('seo.store') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body demo-vertical-spacing demo-only-element">
                                        ...
                                        <input type="text" class="form-control" name="page" id="page" placeholder="Enter page" required />
                                        ...
                                        <input type="text" class="form-control" name="h1" id="h1" placeholder="Enter H1" />
                                        ...
                                        <textarea class="form-control" name="keywords" id="keywords" rows="5" placeholder="Enter Keywords"></textarea>

                                        <label for="scripts" class="form-label">Scripts</label>
                                        <textarea class="form-control" name="scripts" id="scripts" rows="5" placeholder="Enter Scripts"></textarea>

                                        <label for="og:title" class="form-label">Open Graph Title</label>
                                        <input type="text" class="form-control" name="og:title" id="og:title" placeholder="Enter Open Graph Title" />

                                        <label for="og:description" class="form-label">Open Graph Description</label>
                                        <textarea class="form-control" name="og:description" id="og:description" rows="5" placeholder="Enter Open Graph Description"></textarea>

                                        <label for="og:image" class="form-label">Open Graph Image</label>
                                        <input type="file" class="form-control" name="og:image" id="og:image" />

                                        <label for="image" class="form-label">Image</label>
                                        <input type="file" class="form-control" name="image" id="image" />

                                        <label for="canonical" class="form-label">Canonical links</label>
                                        <input type="text" class="form-control" name="canonical" id="canonical" placeholder="Enter Canonical URL" />
