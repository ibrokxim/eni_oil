        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4">Атрибуты </h4>
                    <!-- Custom file input -->
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <h5 class="card-header">Добавить атрибуты</h5>
                                ...
                                <div class="card-body demo-vertical-spacing demo-only-element">
                                    ...
                                    <input type="text" class="form-control" name="code" id="defaultFormControlInput" placeholder="Введите код продукта" aria-describedby="defaultFormControlHelp"/>
