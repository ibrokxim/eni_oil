        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    <a type="button" class="btn btn-primary" href="{{ route('attributes.create') }}">Добавить атрибут</a>
                    <br>
                    <br>
                    <div class="card">
                        <h5 class="card-header">Атрибуты товаров</h5>
                            ...
                            <table class="table">
                                ...
                                @foreach($attributes as $attr)
                                    <tr>
                                        ...
                                        <td>{{ $attr->value }}</td>
                                        <td>{{ $attr->code }}</td>
                                        <td><a href="{{route('attributes.edit', $attr->id)}}" type="button" class="btn btn-primary">Изменить</a></td>
                                        <td><a href="{{route('attributes.delete', $attr->id)}}" type="button" class="btn btn-danger">Удалить</a></td>
                                    </tr>
                                @endforeach
