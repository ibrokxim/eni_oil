            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <h5 class="card-header">Изменить спецификацию {{$attributes->name}}</h5>
                                <form action="{{ route('specifications.update', $attributes->id) }}" method="post">
                                    @csrf
                                    @method('PUT')
                                    <div class="card-body demo-vertical-spacing demo-only-element">
                                        <label for="defaultFormControlInput" class="form-label">Название</label>
                                        <input type="text" class="form-control" name="name" id="defaultFormControlInput" placeholder="Введите название" aria-describedby="defaultFormControlHelp" value="{{ $attributes->name }}"/>

                                        <label for="defaultFormControlInput" class="form-label">Код</label>
                                        <input type="text" class="form-control" name="code" id="defaultFormControlInput" placeholder="Введите код спецификации" aria-describedby="defaultFormControlHelp" value="{{ $attributes->code }}"/>

                                        <label for="defaultFormControlInput" class="form-label">Значение</label>
                                        <input type="text" class="form-control" name="value" id="defaultFormControlInput" placeholder="Введите значение" aria-describedby="defaultFormControlHelp" value="{{ $attributes->value }}"/>
